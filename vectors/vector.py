...
class Vector(VectorBase):
    ...
    def from_horizontal(h, a, radius=1):  # перевод из полярной в декартову систему
        ...
        y = sin(a) * pr
        v = Vector(x, y, z)
        v._pdir = (cos(a), sin(a))  # создали переменную _pdir, присвоили ей кортеж
        # из двух значений cos(a) и sin(a)
        # _pdir - нормализованный вектор, указывающий в направлении,
        # которое определяется углом а
        return v
